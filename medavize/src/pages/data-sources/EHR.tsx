...
import { Database, Search, ChevronLeft, X, RefreshCw, Building2, Pill, FlaskConical, AlertTriangle } from 'lucide-react'
      ...
      <header className="bg-black px-5 py-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/data-sources')} className="flex items-center text-white hover:text-emerald-400 transition">
      ...
      <div className="bg-neutral-100 px-5 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">EHR Integration</h1>
              <p className="text-muted-foreground">Connect via Particle Health</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-card p-6">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-600 bg-white text-foreground"
                />
              </div>
              ...
              <div className="space-y-2">
                {filteredProviders.map((provider) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 p-4 border border-border rounded-lg hover:border-emerald-500 hover:bg-emerald-50 transition text-left"
                  >
