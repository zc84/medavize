      ...
      <div className="bg-navy-900 px-6 py-4">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-2">
            <span className="text-white font-semibold">Step 4 of 7</span>
            <span className="text-navy-300 text-sm">Google Health</span>
          </div>
          <div className="h-2 bg-navy-800 rounded-full">
            <div className="h-full w-[56%] bg-teal-500 rounded-full transition-all"></div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
        <div className="max-w-md w-full text-center">
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-br from-teal-500 to-teal-700 rounded-full p-6">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 text-left">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-teal-600" />
                <span className="text-neutral-700">Sleep Data</span>
              </div>
              <div className="flex items-center gap-3">
                <Check className="w-5 h-5 text-teal-600" />
