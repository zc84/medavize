    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="bg-white rounded-xl shadow-sm p-8 space-y-6">
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-3">4. Health Data Disclaimer</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-3">5. Privacy and Data Protection</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-3">7. Modifications to Terms</h2>
            <p className="text-neutral-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-neutral-900 mb-3">8. Contact Information</h2>
            <p className="text-neutral-600 leading-relaxed">
